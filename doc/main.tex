...
\nc{\mytitle}{Pràctica 2: Models probabilístics}
\nc{\mysubtitle}{Bayesian Inference}
\nc{\authors}{Oriol Alàs Cercós, Marta Albets Mitjaneta, Sergi Simón Balcells}
\nc{\datetime}{8 de Juny de 2020}
...
\subfile{parsing/parsing.tex}
\subsection{Partició de les dades}
\subfile{partition/partition.tex}
\section{Models}
\subfile{models/models.tex}
\newpage\appendix
\section{Gràfics}
\label{app:grafics}
\subfile{annex/graphs.tex}
\end{document}
